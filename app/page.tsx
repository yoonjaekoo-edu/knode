...
export default function Home() {
  ...
  async function handleArticleClick(e:MouseEvent<HTMLDivElement>){
    ...
    if(href.startsWith("/wiki/")) raw=href.slice(6);
    else if(href.startsWith("./")) raw=href.slice(2);
    else return;
